class TunnelMap {
    ...
    _createCanvasOverlay() {
        const canvasLayer = L.canvasOverlay({
    ...
    _createPopupContent(props) {
        ...
        content += `<button class="view-detail-btn" onclick="event.stopPropagation(); window.App.showDeviceDetail('${props.device_id}')">查看详情</button>`;
        content += `</div>`;
